...
import useEditFirebaseProject from "@/hooks/use-editFirebaseData";
...
export default function EditProjectComp({ data, thumbnail, id }: EditProjectProps) {
  const { push } = useRouter();

  //Send data to firebase
  const { sendData, onSuccess, error, loading } =
    useEditFirebaseProject("projects", id);
