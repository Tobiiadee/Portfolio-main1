  ...
  return (
    <div className='flex flex-col gap-6 w-full'>
      ...
      <div className='flex flex-col md:flex-row gap-10 md:gap-52'>
        <div className='grid gap-3 w-max'>
        ...
        <div className='md:self-center flex gap-4 items-center h-10 px-2 py-1'>
          <Link href={"/"} target="blank">
            <Text variant={"h5"}>
              <svg
                ...
                width='25'
                height='25'
                className="hover:scale-110 transition duration-300 bg-muted-foreground rounded-md"
                viewBox='0 0 24 24'>
